...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # for setting inputs
        parser.add_argument('--input_path', type=str, default='dataset/landscape_dataset')
        parser.add_argument('--dataroot', type=str, default='dataset/landscape_dataset')
        ...
        parser.add_argument('--maskmix', action='store_true', default=True, help='use mask in correspondence net')
        parser.add_argument('--use_attention', action='store_true', default=True, help='and nonlocal block in G and D')
        parser.add_argument('--warp_mask_losstype', type=str, default='direct', help='type of warped mask loss, none/direct/cycle')
        ...
        parser.add_argument('--PONO', action='store_true', default=True, help='use positional normalization ')
        parser.add_argument('--PONO_C', action='store_true', default=True, help='use C normalization in corr module')
        parser.add_argument('--eqlr_sn', action='store_true', help='if true, use equlr, else use sn')
        parser.add_argument('--vgg_normal_correct', action='store_true', default=True, help='if true, correct vgg normalization and replace vgg FM model with ctx model')
